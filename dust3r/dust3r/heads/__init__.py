...
from .dpt_head import create_dpt_head, create_dpt_head_uq, create_dpt_head_uq_feat
...
def head_factory(head_type, output_mode, net, has_conf=False):
    ...
    elif head_type == 'dpt_uq' and output_mode == 'pts3d':
        return create_dpt_head_uq(net, has_conf=has_conf)
    elif head_type == 'dpt_uq_feat' and output_mode == 'pts3d':
